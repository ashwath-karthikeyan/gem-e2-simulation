...
class lanenet_detector():
    ...
    def combinedBinaryImage(self, img):
        ...
        SobelOutput = self.gradient_thresh(img, thresh_min= 100, thresh_max=170)
    ...
    def perspective_transform(self, img, verbose=False):
        ...
        warped_img = cv2.warpPerspective(img,M,(1000,800),flags=cv2.INTER_LINEAR)
        #
        #cv2.imshow("wrap",warped_img)
        #cv2.waitKey(0)
